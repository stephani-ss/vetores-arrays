...
public class Vetor {
	...
	//adicionar elemento no vetor, pode ser do tipo void pois não irá retornar nada. Esse metódo recebe o elemento
	//que será adicionado
	//public void adiciona(String elemento) {
		//verifica quais espaços nulos podem ser utilizados (false, null e 0)
		// a maneira abaixo não é a ideal e sim guardar o tamanho real do vetor 
		/*for(int i=0; i<this.elementos.length; i++) {
			if (this.elementos[i]==null) {
				this.elementos[i] = elemento;
				// freiar o loop do for quando achar um espaço vazio, pois o for está indo até 
				// o final do vetor
				break;
				}
		}
